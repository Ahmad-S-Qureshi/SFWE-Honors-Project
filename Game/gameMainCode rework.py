...
def main():
    ...
    font.set_bold(False)
    text = font.render("This is a test of skill and luck", 1, (180, 180, 180))
    ...
    textpos3 = Rect(0, temp2[1]-80, temp.w, temp.h+50)
    ...
    # Prepare fourth line of opening text
    text5 = font.render("You do not need to press them at the same time, just press them", 1, (180, 180, 180))
    temp = text5.get_rect()
    textpos5 = Rect(0, 120, temp.w, temp.h)
